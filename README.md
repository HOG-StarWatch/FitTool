...
| 版本 | 贡献者 |
|------|--------|
| JS-Express-\@garmin_fitsdk V1.5 | [HOG-StarWatch](https://github.com/HOG-StarWatch)（前端重构、后端维护、新增地图源支持） |
...
| 项目 | 来源 |
|------|------|
| JS-Express-\@garmin_fitsdk V1.0-V1.2 开源者 | [黑心商家瑶瑶](https://space.bilibili.com/439315192) |
