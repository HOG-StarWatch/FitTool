...
| 版本 | 介绍 | 部署需求 | 适用场景 |
|------|------|----------|----------|
| **JS-Express-@garmin_fitsdk** | 传统服务器部署 | 需要完全控制服务器环境 | 适用于本地开发和测试环境 |
| **TS-Hono** | 兼容本地 支持 Cloudflare Workers 部署 | 无需服务器 边缘部署 | 免服务器、全球加速、快速部署 |
...
## 开发者
Js-Express-@garmin_fitsdk_V1.5：前端重构 后端维护 新增地图源支持
TS-Hono_V1.0：初始版本：
[**HOG-StarWatch**](https://github.com/HOG-StarWatch)

## 特别鸣谢

Js+Express-@garmin_fitsdk_V1.2 开源者：
